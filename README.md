...
<body class="p-4 md:p-8 flex items-center justify-center">
    ...
    <!-- Кнопки управления аудио и настройками -->
    <div class="control-panel">
        <!-- Настройки (видны вам для быстрой подгрузки Мота и создания именных ссылок) -->
        <div class="control-btn" id="settings-toggle" onclick="toggleSettings()" title="Настроить музыку и гостей">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-[#7d8463]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <!-- Плеер -->
        <div class="control-btn music-btn" id="music-toggle" onclick="toggleMusic()" title="Включить/выключить музыку">
            <svg id="music-icon" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-[#7d8463]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19V6l12-3v13M9 19c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zm12-3c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zM9 10l12-3" />
            </svg>
        </div>
    </div>

    <!-- Секретный пульт настройки аудиофайла и имен гостей -->
    <div class="settings-modal" id="settings-panel">
        <h4 class="font-medium text-xs uppercase tracking-wider mb-3 text-[#7d8463]">Панель Организатора</h4>
        
        <!-- НАСТРОЙКА ИМЕНИ ГОСТЯ -->
        <div class="mb-4 pb-3 border-b border-slate-100">
            <label class="block text-[10px] uppercase text-slate-500 mb-1 font-semibold">Имя получателя (гостя)</label>
            <input type="text" id="guest-input" placeholder="Дорогие Мама и Папа" class="text-xs w-full p-2 border border-slate-300 rounded mb-1" oninput="updateGuestName(this.value)">
            <p class="text-[9px] text-slate-400">Напечатайте имя, чтобы увидеть его на карточке.</p>
            <div class="mt-2 bg-slate-50 p-1.5 rounded text-[9px] text-slate-600 truncate" id="guest-url-preview">
                Ссылка: ...
            </div>
        </div>
        ...
        <!-- НАСТРОЙКА АУДИО -->
        <div class="mb-4">
            <label class="block text-[10px] uppercase text-slate-500 mb-1 font-semibold">Загрузить трек Мота</label>
            <input type="file" id="audio-file" accept="audio/*" class="text-xs w-full p-1 border border-dashed border-slate-300 rounded mb-2" onchange="handleFileSelect(event)">
            
            <label class="block text-[10px] uppercase text-slate-500 mb-1 font-semibold">Или прямая ссылка на MP3</label>
            <input type="text" id="audio-url" placeholder="https://videotourl.com/audio/1779183515989-55ead8c4-1eaa-4126-b368-a5cdbc73b41b.mp3" class="text-xs w-full p-2 border border-slate-300 rounded" onchange="handleUrlSelect(this.value)">
        </div>

        <button onclick="toggleSettings()" class="w-full py-1.5 bg-[#7d8463] text-white rounded text-xs font-medium">Закрыть настройки</button>
    </div>
